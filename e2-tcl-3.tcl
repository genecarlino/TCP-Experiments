...
# Create output file names based on TCP option and CBR rate input
set output_file_1 "exp_2_${tcp_option_1}_${cbr_rate}_flow1.tr"
set output_file_2 "exp_2_${tcp_option_2}_${cbr_rate}_flow2.tr"

# Making an NS Simulator
global nf ns
set ns [new Simulator]

# Writing Trace data to files
set nf_1 [open $output_file_1 w]
set nf_2 [open $output_file_2 w]
$ns trace-all $nf_1
$ns trace-all $nf_2

# Filter the trace events based on flow ID
$ns trace $nf_1 -filter "fid==1"
$ns trace $nf_2 -filter "fid==2"
...
# Close trace files and run the simulation
$ns at 10.6 "close $nf_1"
$ns at 10.6 "close $nf_2"
